...
const steps: TutorialStep[] = [
  ...
  },
  {
    ...
    description:
      "The story for the selected scene appears here. Some entries also include quotes and audios.",
  ...
  },
  {
    ...
    description:
      "Use the buttons to move forwards and backwards throughout Steen's journey. Keep track of your discovered interactive objects.",
    targetPoint: { x: 0.95, y: 0.5 },
  },
];
